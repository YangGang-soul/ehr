        ...
        return (
            <footer className="nav-footer">
                <section className="sitemap">
                    <a href="/react/" className="nav-home">
                    </a>
                    <div>
                ...
                <a href="https://code.facebook.com/projects/" target="_blank" className="fbOpenSource">
                    <img src="/assets/img/oss_logo.png" alt="Facebook Open Source" width="170" height="45"/>
                </a>
                <section className="copyright">
                    Copyright © {this.props.auth.APP_COPY_RIGHT} Facebook Inc.
                </section>
            </footer>
        );
    }
