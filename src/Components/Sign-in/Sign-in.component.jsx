  ...
  handleBlur(event) {
    const value = event.target.value;
     if(!validator.isMobilePhone(value,'zh-CN')){
          this.setState({validator: {invalidPhone: true }}) ;
      }
      else
      {
          this.setState({validator: {invalidPhone: false}}) ;
      }
  }
  ...
  handleBlurPassword(event) {
       const value = event.target.value;
        ...
        if(validator.isEmpty(value) 
           || !validator.isLength(value,{min:6, max: 20})
        ){
            this.setState({  validator:{  invalidPassword: true  }  }  ) ;
        }else
        {
          this.setState({  validator:{  invalidPassword: false  }  }  ) ;
        }
  }

  handleClick() {
       //const value =  e.target.value;
    console.log('this is Click:', this.value);
  }
                    ...
                    <div className="modal-content">
                        ...
                        <form className="form-horizontal"
                            ...
                            <div className="form-group">
                                ...
                                { this.state.validator.invalidPassword ? <div className="alert alert-danger">
                                     <p>密码不能为空(长度6-20位)</p>
                                  </div> :"" 
                                }               
                                </div>
